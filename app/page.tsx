      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 gap-6">
          {Array.from({ length: 19 }, (_, index) => (
            <Card key={index} className="bg-white border border-gray-200 rounded-lg p-6 relative min-h-[140px] w-full transition-all duration-300 ease-in-out hover:scale-105 hover:border-2 hover:border-[#26baf1] hover:shadow-lg cursor-pointer">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 text-left">
                  <h3 className="text-xl font-bold text-gray-900 mb-2 pt-[10px]">
                    {index === 1
                      ? "Worldsmart"
                      : index === 2
                        ? "Igneo"
                  ...
                  <p className="text-gray-600 text-xs pb-[20px]">
                    {index === 2
              ...
              <div className="absolute bottom-4 right-4 flex items-center gap-1 text-gray-500 pt-[10px]">
